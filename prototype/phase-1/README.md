...
- `layout-variations.html`: perbandingan A — Speed First, B — Guided Checkout, dan C — Compact Operations.
- `pos-prototype.html`: prototype interaktif final, memakai A pada desktop dan B pada mobile.
